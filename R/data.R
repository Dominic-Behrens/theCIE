#' CIE chart types
#'
#' A tibble containing the CIE chart types and their characteristics.
#'
#' @format A tibble with 12 variables:
#' \describe{
#'   \item{type}{Chart type, such as "normal" or "fullslide". Supply this to the `type` argument of `cie_save()`.}
...
#'   \item{class}{There are two "classes" of chart: "normal" and "fullslide". "Normal" charts are those bound for reports - by default they are saved without their labels and sans logo. Fullslide charts look like a CIE Powerpoint slide, with the logo and orange line.}
