...
theme_cie_base <- function(base_size = 18,
                               base_family = "sans",
  ...
  ret <-
    theme(
      line = element_line(
        colour = cietheme::cie_gridlinegrey,
      ...
      axis.text.x = element_text(margin = margin(t = base_size / 3,
                                                 unit = "pt"),
                                 vjust = 1),
      axis.text.x.top = element_text(margin = margin(b = base_size / 5),
                                     vjust = 0),
      axis.text.y = element_text(margin = margin(r = base_size / 3),
                                 hjust = 1),
      ...
      panel.grid = element_line(colour = cietheme::cie_gridlinegrey,
      ...
      plot.title = element_text(
        ...
        hjust = 0,
        vjust = 1,
        colour = cietheme::cie_grey_title,
        face = "bold",
  ...
  if (background == "orange" |  background == "box") {
    ret <- ret +
      ggplot2::theme(rect = element_rect(
        fill = cietheme::cie_orange_alpha))
  }
