...
test_plot <- ggplot(mtcars, aes(x = wt, y = mpg, col = factor(cyl))) +
  ...
  cie_y_continuous(limits = c(0, 40)) +
  labs(x = "Weight",
...
test_that("cie_save() saves charts (no powerpoint)", {

  test_dir <- file.path(tempdir(), "cie_save_test")
  dir.create(test_dir, recursive = TRUE, showWarnings = FALSE)

  cie_save(filename = file.path(test_dir, "test_plot.png"),
               object = test_plot,
               save_pptx = FALSE,
               save_data = FALSE,
               type = "all")
...
test_that("cie_save() saves charts (with powerpoint)", {
...
test_that("cie_save() saves last_plot() and works with repeated calls", {
  ...
  cie_save(file.path(test_dir, "test.png"), type = "all", save_pptx = TRUE)
...
test_that("cie_save() doesn't save chart data / PPTX when not requested", {
...
test_that("cie_save() saves chart data when requested",{
  ...
  cie_save(filename = file.path(test_dir, "test.pdf"),
               object = test_plot,
               force_labs = FALSE,
               type = "normal",
               save_data = TRUE,
...
test_that("cie_save() respects select_data and round parameters", {
  ...
  cie_save(filename = "test_select.pdf",
  ...
  cie_save(filename = "test_noselect.pdf",
               object = plot_with_extra_cols,
               force_labs = FALSE,
               type = "normal",
               save_data = TRUE,
  ...
  cie_save(filename = "test_round.pdf",
               object = test_plot,
               force_labs = FALSE,
               type = "normal",
               save_data = TRUE,
...
test_that("cie_save() height behaviour works as expected with normal charts", {

  cie_save(filename = "test_plot_normal_default_height.png",
               object = test_plot,
               type = "normal",
               device = 'png')

  cie_save(filename = "test_plot_normal_manual_height.png",
               object = test_plot,
               type = "normal",
               height = 20,
               device = 'png')
...
test_that("cie_save() height behaviour works as expected with fullslide charts", {

  cie_save(filename = "default_height.png",
               object = test_plot,
               type = "fullslide",
               device = 'png')

  cie_save(filename = "manual_height.png",
               object = test_plot,
               type = "fullslide",
               height = 40,
               device = 'png')
...
test_that("cie_save() sends the right messages",{
  expect_error(
  cie_save(filename = "test_plot_normal_default_height.png",
               object = test_plot,
               type = "nahhhh mate")
...
test_that("cie_save() saves a plot with a watermark", {

  cie_save(filename = "test_plot_watermark.png",
               object = test_plot,
               watermark = "DRAFT")
...
test_that("cie_save() respects no_new_folder parameter", {
  ...
  cie_save(filename = file.path(test_dir, "with_folder.png"),
               object = test_plot,
               type = "normal")
  ...
  cie_save(filename = file.path(test_dir, "without_folder.png"),
               object = test_plot,
               type = "normal",
               no_new_folder = TRUE)
  ...
  cie_save(filename = file.path(test_dir, "without_folder_data.png"),
               object = test_plot,
               type = "normal",
               no_new_folder = TRUE,
               save_data = TRUE)
  ...
  cie_save(filename = file.path(test_dir, "without_folder_pptx.png"),
               object = test_plot,
               type = "fullslide",
               no_new_folder = TRUE,
               save_pptx = TRUE)
...
# I'm going to update the cie_save_all works test_that function so that it works with a temp_dir as per the tests above.

test_that("cie_save_all() works", {
  ...
  cie_save_all(filename = file.path(test_dir, "test_plot.png"),
                   object = test_plot)
...
test_that("cie_save(ignore_long_titles = TRUE) successfully ignores long titles", {
