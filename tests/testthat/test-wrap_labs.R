...
test_that("caption wraps onto two lines", {
  ...
  p <- base_plot +
    labs(caption = "Notes: Some extremely long notes go here, because sometimes (often!) CIE people like to append extremely long notes to the bottom of their charts, you have probably noticed this already huh. Source: source goes here.")
